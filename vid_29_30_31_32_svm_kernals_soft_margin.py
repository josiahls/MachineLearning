...
***Note the code below belongs to Mathieu Blondel
Website link: http://mblondel.org/

None of this is mine, however Mathieu seems to have dropped
 support for his journal section of his website, so I could
  not find a link or original code. This was copied from 
  https://www.youtube.com/watch?v=XdcfJX-mDG4&index=32&list=PLQVvvaa0QuDfKTOs3Keq_kaG2P55YRn5v
  which ran through Mathieu's code and explained it. 
"""
import numpy as np
...
def plot_contour(X1_train, X2_train, clf):
    ...
    pl.contour(X1, X2, Z, [0.0], colors='k', linewidth=1, origin='lower')
    pl.contour(X1, X2, Z + 1, [0.0], colors='grey', linewidth=1, origin='lower')
    pl.contour(X1, X2, Z - 1, [0.0], colors='grey', linewidth=1, origin='lower')
